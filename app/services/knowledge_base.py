...
class KnowledgeBaseService:
    ...
    async def get_faqs_by_category(self, category: str) -> List[KnowledgeBase]:
        ...
        try:
            ...
            logger.error(
                "Error getting FAQs by category", category=category, error=str(e)
            )
            return []
        finally:
            db.close()
    ...
    async def create_faq(
        self, question: str, answer: str, keywords: List[str], category: str = "general"
    ...
    async def search_similar_faqs(
        ...
        try:
            ...
            for faq in faqs:
                ...
                total_score = (
                    keyword_overlap * 3 + question_overlap * 2 + answer_overlap
                )

                if total_score > 0:
                    scored_faqs.append({"faq": faq, "score": total_score})
